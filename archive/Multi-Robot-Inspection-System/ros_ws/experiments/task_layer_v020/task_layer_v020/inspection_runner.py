...
from task_layer_v020.report_writer import default_report_dir, write_report
from task_layer_v020.scan_analyzer import aggregate_scan_summaries, summarize_scan
...
class InspectionRunner(Node):
    def __init__(self):
        ...
        self.declare_parameter('return_home_standoff_distance', 0.6)
